...
🔹Tanggal : ${calender}`
if (modelmenu == 'butloc'){
sendButLocation(from, `${menu}`, `${uwu}*💠ArtahZyx💠*${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'ALLMENUZ💠'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNERZ💠'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SEWA BOTZ💠'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
}
...
break
		...
		case 'sc':
		case 'sourcecode':
		denz.sendMessage(from, { text: "5K Manen Wa.me/6285784786722", matchedText: ' 5k Manen Wa.me/6285784786722', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
